...
<body>
  ...
  <section>
    <div class="title-section">
      <h2> <strong>Agregar Nuevo Producto</strong></h2>
    </div>
    <div class="container">
                ...
                <div class="row m-l-0 m-r-0">
                  <div class="col-sm-4 bg-c-lite-green product-profile">
                    <div class="card-block text-center text-white">
                      <div class="m-b-25">
                        <img src="./assets/images/upload-image.webp" class="img-radius" alt="Product-Image">
                      </div>
                  ...
                  <div class="col-sm-8">
                    ...
                    <form class="form-card mt-3" action="" method="post" enctype="multipart/form-data">
                      <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex">
                          ...
                          <input type="text" id="tipo_prenda" name="tipo_prenda" placeholder="" value="" onblur="validate(1)">
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex">
                          <label class="form-control-label px-3">Marca</label>
                          <input type="text" id="marca" name="marca" placeholder="" value="" onblur="validate(2)">
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-between text-left mt-3">
                        <div class="form-group col-sm-6 flex-column d-flex">
                          ...
                          <input type="text" id="talle" name="talle" placeholder="" value="" onblur="validate(3)">
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex">
                          <label class="form-control-label px-3">Precio</label>
                          <input type="text" id="precio" name="precio" placeholder="" value="" onblur="validate(4)">
                        </div>
                      </div>

                      <div class="row justify-content-between text-left mt-3">
                        <div class="form-group flex-column d-flex ">
                          <label class="form-control-label px-3">Subir imagen</label>
                          <input type="file" name="imagen" placeholder="" class="no-uppercase"><br>
                        </div>
                      </div>
                    ...
                    if (array_key_exists('guardar_cambios', $_POST)) {
                      ...
                      $consulta = "INSERT INTO productos (id, tipo_prenda, marca, talle, precio, imagen) VALUES (NULL, '$tipo_prenda', '$marca', '$talle', '$precio', '$imagen')";
